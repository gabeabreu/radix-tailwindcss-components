        ...
        <DialogPrimitive.Root open={isOpen} onOpenChange={setIsOpen}>
            ...
            <Transition.Root show={isOpen}>
                ...
                >
                    ...
                    >
                        <DialogPrimitive.Title className="text-sm font-medium text-gray-900 dark:text-gray-100">{title}</DialogPrimitive.Title>
                        <DialogPrimitive.Description className="mt-2 text-sm font-normal text-gray-700 dark:text-gray-400">{description}</DialogPrimitive.Description>
                        <form className="mt-2 space-y-2">
                            ...
                            <fieldset>
                                <label htmlFor="familyName" className="text-xs font-medium text-gray-700 dark:text-gray-400">
                                    {secondInputText}
                                </label>
                                <input
                                    id="familyName"
